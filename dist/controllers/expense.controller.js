...
const addExpense = async (req, res) => {
    ...
    try {
        ...
        if (user?.role === 'SUB_ADMIN') {
            ...
            if (customerIdNum) {
                const custRes = await (0, pool_1.query)('SELECT id, branch_id FROM users WHERE id = $1', [customerIdNum]);
        ...
        const dbRes = await (0, pool_1.query)(`INSERT INTO expenses (builty_id, branch_id, sub_admin_id, customer_id, expense_title, category, amount, expense_date, notes) 
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) 
       RETURNING *`, [builty_id || null, finalBranchId, subAdminId, customerIdNum, expense_title.trim(), cat, amt, expDate, notes || '']);
        return res.json({
            status: true,
